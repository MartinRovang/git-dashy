...
␣ unfold/fold older reviews of the same PR, a auto, m model, d depth, e effort, t REVIEWED window, i interval, s summaries, D hide/show drafts, n repo memory, g general memory ($EDITOR), T team repo setup, u install the newest release, r refresh, q quit."""
